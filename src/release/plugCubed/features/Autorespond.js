define(['plugCubed/handlers/TriggerHandler', 'plugCubed/Lang', 'plugCubed/Settings', 'plugCubed/RoomSettings', 'plugCubed/Utils', 'plugCubed/bridges/PlaybackModel', 'plugCubed/dialogs/Menu', 'lang/Lang'], function(TriggerHandler, p3Lang, Settings, RoomSettings, p3Utils, PlaybackModel, Menu, Lang) {
    var handler = TriggerHandler.extend({
        ...
        handler: function(data) {
            ...
            if (a || b) {
                if (data.message.indexOf('!afkdisable') > -1 && (typeof RoomSettings.rules.allowAutorespond === 'undefined' || RoomSettings.rules.allowAutorespond !== false)) {
            ...
            if (data.type == 'mention') {
                if (Settings.autorespond && !Settings.recent && (typeof RoomSettings.rules.allowAutorespond === 'undefined' || RoomSettings.rules.allowAutorespond !== false)) {
