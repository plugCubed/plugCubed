                                        ...
                                        if (path.length > 3) {
                                            ...
                                            if (path.trim().length !== 0) {
                                                ...
                                                $.getJSON('https://gfycat.com/cajax/get/' + path, function (videoData) {
                                                        ...
                                                        webmUrl = p3Utils.httpsifyURL(videoData.gfyItem.webmUrl; mp4Url = p3Utils.httpsifyURL(videoData.gfyItem.mp4Url; imgUrl = p3Utils.httpsifyURL(videoData.gfyItem.gifUrl;

                                                                $video.append($('<source>').attr('type', 'video/webm').attr('src', webmUrl)); $video.append($('<source>').attr('type', 'video/mp4').attr('src', mp4Url)); $video.append($('<img>').attr('src', imgUrl));
                                                            });
                                                        }
                                                    }
                                                ...
                                                if (p3Utils.startsWithIgnoreCase(url, ['http://imgur.com/gallery/', 'https://imgur.com/gallery/', 'http://imgur.com/', 'https://imgur.com/'])) {
                                                    path = url.split('/');
                                                    if (path.length > 4) {
                                                        path = path[4];
                                                        if (path.trim().length !== 0) {
