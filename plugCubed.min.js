...
*/
"undefined"!==typeof plugCubed&&plugCubed.close();function x(b){return!isNaN(parseInt(b,10))&&isFinite(b)}function I(b){return/^(#|)(([0-9A-F]{6}$)|([0-9A-F]{3}$))/i.test("#"===b.substr(0,1)?b:"#"+b)}Math.sa=function(){return 1+Math.floor(10*Math.random())};var plugCubed,T;
...
I(a.colors.chat[c])&&(g[c]="#"===a.colors.chat[c].substr(0,1)?a.colors.chat[c].substr(1):a.colors.chat[c]);q=g}}else y.n("rss-background-color");void 0!==a.images?(v.defaultRoomElements(),void 0!==a.images.O?b("#room-wheel").css("display",a.images.O.ya&&"false"===a.images.O.ya?"none":""):b("#room-wheel").css("display",""),f.trigger("audience:redraw"),a.images.background?y.set("rss-background-image",'body { background-image: url("'+a.images.background+'")!important; }'):y.n("rss-background-image"),
b("#p3-dj-booth").remove(),void 0!==a.images.P&&b("#dj-booth").append(b('<div id="p3-dj-booth">').css("background-image",'url("'+a.images.P.P+'")')),r=a.images.La):(v.defaultRoomElements(),b("#room-wheel").css("display",""),y.n("rss-background-image"),y.n("rss-booth"),f.trigger("audience:redraw"));plugCubed.B()}}function L(){var a=k.get("description"),g=plugCubed.settings.useRoomSettings[window.location.pathname.split("/")[1]];if(null!==a&&-1<a.indexOf("@p3=")){a=a.substr(a.indexOf("@p3=")+4);if(void 0===
g||!0===g)return b.getJSON(a,function(a){E(a)});F=!0;plugCubed.Na()}}function B(a){a=a.trim();"@"===a.substr(0,1)&&(a=a.substr(1));var b=API.getUsers(),c;for(c in b)if(("string"!==typeof a?0:b[c].username.toLowerCase()===a.toLowerCase())||("string"!==typeof a?0:b[c].id.toLowerCase()===a.toLowerCase()))return b[c];return null}function C(a){a=B(a);if(null===a)API.chatLog(c.i18n("error.userNotFound"));else{var b,d,l,k,f=a.ba+a.$+a.ha;d=API.getWaitListPosition(a.id);var h=API.getDJ().id===a.id;l=a.language;
k=e.Wa.concat(e.Ha);for(b in k)k.value===l&&(l=k[b].label);b=API.hasPermission(a.id,API.ROLE.ADMIN)?c.i18n("ranks.admin"):API.hasPermission(a.id,API.ROLE.AMBASSADOR)?c.i18n("ranks.ambassador"):API.hasPermission(a.id,API.ROLE.HOST)?c.i18n("ranks.host"):API.hasPermission(a.id,API.ROLE.COHOST)?c.i18n("ranks.cohost"):API.hasPermission(a.id,API.ROLE.MANAGER)?c.i18n("ranks.manager"):API.hasPermission(a.id,API.ROLE.BOUNCER)?c.i18n("ranks.bouncer"):API.hasPermission(a.id,API.ROLE.RESIDENTDJ)?c.i18n("ranks.residentdj"):
c.i18n("ranks.regular");k=h?c.i18n("info.djing"):-1<d?c.i18n("info.inwaitlist",d+1,API.getWaitList().length):c.i18n("info.notinlist");switch(a.status){default:d=c.i18n("status.available");break;case API.STATUS.AFK:d=c.i18n("status.afk");break;case API.STATUS.WORKING:d=c.i18n("status.working");break;case API.STATUS.Da:d=c.i18n("status.sleeping")}switch(a.vote){case -1:l=c.i18n("vote.meh");break;default:l=c.i18n("vote.undecided");break;case 1:l=c.i18n("vote.woot")}h&&(l=c.i18n("vote.djing"));h=void 0;
...
b("#plug-dj").after(S);S.click(this.proxy.I);b("#room-bar").css("left",108);this.ia();this.fa();var a=API.getUsers(),g;for(g in a)0>t(a[g].id,"joinTime",-1)&&w(a[g].id,"joinTime",Date.now());b("#chat-header").append(b("<div>").addClass("chat-header-button p3-s-stream").data("key","stream").click(this.proxy.k).mouseover(function(){f.trigger("tooltip:show",c.i18n("menu.stream"),b(this),!0)}).mouseout(function(){f.trigger("tooltip:hide")})).append(b("<div>").addClass("chat-header-button p3-s-clear").data("key",
...
c.i18n("footer.unknown")))))}V.sio.$events.chat=U.listener.chat=function(a){if("undefined"!==typeof plugCubed&&(a.fromID&&w(a.fromID,"lastChat",Date.now()),-1<plugCubed.settings.ignore.indexOf(a.fromID))){plugCubed.Q(a);return}e.receive(a);API.dispatch(API.CHAT,a)};var H={},R,A={ja:3,ka:0,ra:0,J:"alpha.11",F:!1,toString:function(){return this.ja+"."+this.ka+"."+this.ra+(void 0!==this.J&&""!==this.J?"-"+this.J:"")+(this.F?"_min":"")}},u=[],s,F=!1,q={},r={},S=b('<div id="plug-cubed"><i class="icon icon-plug-cubed"></i></div>'),
...
null,plugCubed.colors.ea),setTimeout(function(){b.getScript("http://alpha.plugcubed.net/plugCubed."+(A.F?"min.":"")+"js")},5E3);if("chat"===a){if(!g.chatID||0<b(".chat-id-"+g.chatID).length||-1<plugCubed.settings.ignore.indexOf(g.fromID))return;e.receive(g);return API.trigger(API.CHAT,g)}if("rave"===a&&(p.isPlugCubedDeveloper(g.id)||p.isPlugCubedSponsor(g.id)||API.hasPermission(g.id,API.ROLE.HOST))){switch(g.value){case 0:return clearTimeout(v.Va),v.ga(!1);case 1:return v.wa=50,v.va=160,v.xa();case 2:return v.ga(!0)}if(50<=
g.value&&100>=g.value)return v.wa=g.value,v.va=3.2*g.value,v.xa()}},s.onclose=function(){console.log("[plug³ Socket Server]","Closed");this.m++;this.X=!0;var a;if(5>this.m)a=5;else if(30>this.m)a=30;else if(60>this.m)a=60;else return;setTimeout(function(){plugCubed.N()},1E3*a);b(".plugcubed-status").text(c.i18n("footer.socket",c.i18n("footer.offline")))}},a:{b:{you:{title:"ranks.you",color:"FFDD6F"},regular:{title:"ranks.regular",color:"B0B0B0"},d:{title:"ranks.residentdj",color:"E90E82"},bouncer:{title:"ranks.bouncer",
color:"E90E82"},manager:{title:"ranks.manager",color:"E90E82"},cohost:{title:"ranks.cohost",color:"E90E82"},host:{title:"ranks.host",color:"E90E82"},ambassador:{title:"ranks.ambassador",color:"9A50FF"},admin:{title:"ranks.admin",color:"42A5DC"}},H:{join:{title:"notify.join",color:"3366FF"},leave:{title:"notify.leave",color:"3366FF"},curate:{title:"notify.curate",color:"00FF00"},stats:{title:"notify.stats",color:"66FFFF"},updates:{title:"notify.updates",color:"FFFF00"}}},settings:{recent:!1,awaymsg:"",
autowoot:!1,autorespond:!1,notify:0,customColors:!1,avatarAnimations:!0,registeredSongs:[],ignore:[],alertson:[],autoMuted:!1,afkTimers:!1,useRoomSettings:{},colors:{you:"FFDD6F",regular:"B0B0B0",d:"E90E82",bouncer:"E90E82",manager:"E90E82",cohost:"E90E82",host:"E90E82",ambassador:"9A50FF",admin:"42A5DC",join:"3366FF",leave:"3366FF",curate:"00FF00",stats:"66FFFF",updates:"FFFF00"}},ia:function(){try{var a=JSON.parse(d.getItem("plugCubed")),b;for(b in this.settings)void 0!==a[b]&&(this.settings[b]=
a[b]);this.settings.recent=!1;this.settings.afkTimers&&O();this.settings.autowoot&&N();this.B();63<this.settings.notify&&(this.settings.notify=0);0<this.settings.registeredSongs.length&&-1<this.settings.registeredSongs.indexOf(API.getMedia().id)&&(API.setVolume(0),this.settings.autoMuted=!0,API.chatLog(c.i18n("automuted",API.getMedia().title)))}catch(k){}},g:function(){d.setItem("plugCubed",JSON.stringify(this.settings))},B:function(){var a=[],b=this.settings.useRoomSettings[window.location.pathname.split("/")[1]];
((b=void 0===b||!0===b?!0:!1)&&q.regular||this.settings.colors.regular!==this.a.b.regular.color)&&a.push(".message.from > .from,",".emote.from > .from,",".mention.from > .from { color:#"+(this.settings.colors.regular!==this.a.b.regular.color?this.settings.colors.regular:q.regular)+"!important; }");(b&&q.d||this.settings.colors.d!==this.a.b.d.color)&&a.push(".message.from-residentdj > .from,",".emote.from-residentdj > .from,",".mention.from-residentdj > .from { color:#"+(this.settings.colors.d!==this.a.b.d.color?
this.settings.colors.d:q.d)+"!important; }");(b&&q.bouncer||this.settings.colors.bouncer!==this.a.b.bouncer.color)&&a.push(".message.from-bouncer > .from,",".emote.from-bouncer > .from,",".mention.from-bouncer > .from { color:#"+(this.settings.colors.bouncer!==this.a.b.bouncer.color?this.settings.colors.bouncer:q.bouncer)+"!important; }");(b&&q.manager||this.settings.colors.manager!==this.a.b.manager.color)&&a.push(".message.from-manager > .from,",".emote.from-manager > .from,",".mention.from-manager > .from { color:#"+
(this.settings.colors.manager!==this.a.b.manager.color?this.settings.colors.manager:q.manager)+"!important; }");(b&&q.cohost||this.settings.colors.cohost!==this.a.b.cohost.color)&&a.push(".message.from-cohost > .from,",".emote.from-cohost > .from,",".mention.from-cohost > .from { color:#"+(this.settings.colors.cohost!==this.a.b.cohost.color?this.settings.colors.cohost:q.cohost)+"!important; }");(b&&q.host||this.settings.colors.host!==this.a.b.host.color)&&a.push(".message.from-host > .from,",".emote.from-host > .from,",
".mention.from-host > .from { color:#"+(this.settings.colors.host!==this.a.b.host.color?this.settings.colors.host:q.host)+"!important; }");(b&&q.ambassador||this.settings.colors.ambassador!==this.a.b.ambassador.color)&&a.push(".message.from-ambassador > .from,",".emote.from-ambassador > .from,",".mention.from-ambassador > .from { color:#"+(this.settings.colors.ambassador!==this.a.b.ambassador.color?this.settings.colors.ambassador:q.ambassador)+"!important; }");(b&&q.admin||this.settings.colors.admin!==
this.a.b.admin.color)&&a.push(".message.from-admin > .from,",".emote.from-admin > .from,",".mention.from-admin > .from { color:#"+(this.settings.colors.admin!==this.a.b.admin.color?this.settings.colors.admin:q.admin)+"!important; }");(b&&q.you||this.settings.colors.you!==this.a.b.you.color)&&a.push(".message.from-you > .from,",".emote.from-you > .from,",".mention.from-you > .from { color:#"+(this.settings.colors.you!==this.a.b.you.color?this.settings.colors.you:q.you)+"!important; }");b&&r&&(r.admin&&
a.push(".message.from-admin > .icon,",".emote.from-admin > .icon,",'.mention.from-admin > .icon { background-image: url("'+r.admin+'"); background-position: 0 0; }'),r.ambassador&&a.push(".message.from-ambassador > .icon,",".emote.from-ambassador > .icon,",'.mention.from-ambassador > .icon { background-image: url("'+r.ambassador+'"); background-position: 0 0; }'),r.bouncer&&a.push(".message.from-bouncer > .icon,",".emote.from-bouncer > .icon,",'.mention.from-bouncer > .icon { background-image: url("'+
r.bouncer+'"); background-position: 0 0; }'),r.cohost&&a.push(".message.from-cohost > .icon,",".emote.from-cohost > .icon,",'.mention.from-cohost > .icon { background-image: url("'+r.cohost+'"); background-position: 0 0; }'),r.d&&a.push(".message.from-residentdj > .icon,",".emote.from-residentdj > .icon,",'.mention.from-residentdj > .icon { background-image: url("'+r.d+'"); background-position: 0 0; }'),r.host&&a.push(".message.from-host > .icon,",".emote.from-host > .icon,",'.mention.from-host > .icon { background-image: url("'+
r.host+'"); background-position: 0 0; }'),r.manager&&a.push(".message.from-manager > .icon,",".emote.from-manager > .icon,",'.mention.from-manager > .icon { background-image: url("'+r.manager+'"); background-position: 0 0; }'));this.p.text(a.join("\n"))},fa:function(){API.on(API.CHAT_COMMAND,this.proxy.r);API.on(API.DJ_ADVANCE,this.proxy.s);API.on(API.VOTE_UPDATE,this.proxy.w);API.on(API.CURATE_UPDATE,this.proxy.t);API.on(API.USER_JOIN,this.proxy.u);API.on(API.USER_LEAVE,this.proxy.v);API.on(API.CHAT,
this.proxy.q);API.on(API.VOTE_SKIP,this.proxy.f);API.on(API.USER_SKIP,this.proxy.f);API.on(API.MOD_SKIP,this.proxy.f)},c:function(a,c,d){return b('<div class="item">').addClass("p3-s-"+c+(a?" selected":"")).append(b('<i class="icon icon-check-blue"></i>')).append(b("<span>").text(d)).data("key",c).click(this.proxy.k)},h:function(a,c){b(".p3-s-"+a).removeClass("selected");c&&b(".p3-s-"+a).addClass("selected")},W:function(a,b){if(API.hasPermission(void 0,API.ROLE.BOUNCER)){var d;switch(b){case "removedj":d=
API.moderateRemoveDJ;break;case "adddj":d=API.moderateAddDJ;break;default:API.chatLog(c.i18n("error.unknownModeration"));return}var k=B(a);null===k?API.chatLog(c.i18n("error.userNotFound")):d(k.id," ")}},I:function(){if(void 0!==z)return"0px"===z.css("left")?(z.animate({left:-270}),D.hide()):z.animate({left:0});z=b('<div id="p3-settings" style="left: -270px;">').append(b('<div class="header">').append(b('<div class="back">').append(b('<i class="icon icon-back"></i>')).click(function(){void 0!==z&&
z.animate({left:-270});D.hide()})).append(b('<div class="title">').append(b('<i class="icon icon-settings"></i>')).append(b("<span>plug&#179;</span>")).append(b("<span>").addClass("version").text(A)))).append(b('<div class="container">').append(b('<div class="section">Features</div>')).append(this.c(this.settings.autowoot,"woot",c.i18n("menu.autowoot"))).append(this.c(this.settings.autorespond,"autorespond",c.i18n("menu.autorespond"))).append(b('<div class="item">').addClass("p3-s-autorespond-input").append(b("<input>").val(""===
...
a.message.indexOf(this.settings.alertson[c])&&G()},f:function(){u[1].C=!0},Sa:function(){setTimeout(function(){console.log("Waitlist Show");b("#waitlist .list .user").each(function(){b(this).find(".meta").append(b("<span>").addClass("afk"))})},1)},oa:function(a){if((API.hasPermission(void 0,API.ROLE.BOUNCER)||p.isPlugCubedDeveloper())&&32===(plugCubed.settings.notify&32)){var b=-1,d;for(d in u){var k=u[d];if(k.id==a&&~~d+1<u.length&&(b=~~d+2,!k.C))return G(),setTimeout(function(){G()},50),API.chatLog(c.i18n("historyCheck.inHistory",
...
API.getDJ())return;5<a.length&&API.sendChat("@"+API.getWaitList()[0].username+" - Reason for skip: "+a.substr(5).trim());return API.moderateForceSkip()}if(0===a.indexOf("/whois "))return C(a.substr(7));if(0===a.indexOf("/add "))return this.W(a.substr(5),"adddj");if(0===a.indexOf("/remove "))return this.W(a.substr(8),"removedj")}if(API.hasPermission(void 0,API.ROLE.MANAGER)){if("/lock"===a)return API.moderateLockWaitList(!0);if("/unlock"===a)return API.moderateLockWaitList(!1);"/lockskip"===a&&require(["app/services/room/RoomWaitListLockService"],
...
define("plugCubed/MenuView",["jquery","underscore","backbone","f2428/ad16d/e4296"],function(b,m,h,f){h.Fa.extend({id:"plug-cubed",Oa:function(){this.U=m.bind(this.pa,this);this.S=m.bind(this.na,this);this.K=!1},A:function(){this.o.html();this.o.on("mousedown",m.bind(this.la,this));this.L=this.za("#plug-cubed").remove();return this},la:function(){this.K?this.hide():this.show()},show:function(){this.K=!0;f.trigger("settings:hide").trigger("playback:block");b("body").append(this.L);b("#plug-cubed .clickable").on("mousedown",
this.U);var e=this;m.defer(function(){b(document).on("mousedown",e.S)})},hide:function(){this.K=!1;b(document).off("mousedown",this.S);b("#plug-cubed .item").off("mousedown",this.U);f.trigger("playback:unblock");this.L.remove()},pa:function(e){e=b(e.target);e.is("span")&&e.parent()},na:function(e){e=b(e.target);e.is("span")&&(e=e.parent());if(e.is("a")||e.hasClass("item")){var d=this;m.delay(function(){d.hide()},250)}else this.hide()}});return PlugMenuView});
